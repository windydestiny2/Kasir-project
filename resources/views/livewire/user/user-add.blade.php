    ...
    <div class="card">
        <div class="card-body">
            <div class="box-body">
                <div class="row">
                    <div class="col">
                        <form action="" wire:submit.prevent='addUser' enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                                @if($profil && $profil->isPreviewable())
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <fieldset class="py-2">
                                                        <div class="icheck-primary d-inline">
                                                            <input type="checkbox" id="checkboxPrimary10" wire:model="orderpes"
                                                                value="1">
