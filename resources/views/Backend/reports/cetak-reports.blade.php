  ...
  <section class="invoice p-4">
    ...
    <div class="row mb-3">
      <div class="col-12 text-center">
        <h3 class="font-weight-bold">Laporan Pesanan "Sugoiiyaki"</h3>
        <hr>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-12">
        <table class="table table-striped">
          <div class="header">
            @if($search)
            <p class="text-center">Laporan Riwayat Orderan Tanggal {{ $search }}</p>
            @else
            <p class="text-center">Laporan Semua Riwayat Orderan</p>
            @endif
          </div>
          <thead>
            <tr>
    ...
    <div class="row mt-4">
      ...
      <div class="col-6">
        ...
        <div class="table-responsive">
          <table class="table">
            <tr>
              <th style="width:50%">Jumlah Orderan</th>
              <td>{{ $totalOrder }} (Pesanan) </td>
            </tr>
